 ...
 * @param productTypeColumn - The column reference for product_type
 * @returns Drizzle filter condition
 */
export function createCoffeeProductFilter(productTypeColumn: any) {
 ...
 * @param nameColumn - The name column reference
 * @param descriptionColumn - The description column reference  
 * @param tastingNotesColumn - The tasting notes column reference
 * @returns Drizzle filter condition or undefined if no search term
 */
export function createCoffeeSearchFilter(
  searchTerm: string | undefined,
  nameColumn: any,
  descriptionColumn: any,
  tastingNotesColumn: any
) {
