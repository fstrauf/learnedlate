...
Cash flow discipline separates startups that survive from those that stall. Use our [startup cash runway calculator](./startup_cash_runway_calculator_template_free_download_plan_your_burn_rate_in_minutes/) to model your burn rate and set realistic revenue targets for the first 90 days post-launch.
...
- [Startup Cash Runway Calculator (Free Template)](/blog/startup_cash_runway_calculator_template_free_download_plan_your_burn_rate_in_minutes/)
