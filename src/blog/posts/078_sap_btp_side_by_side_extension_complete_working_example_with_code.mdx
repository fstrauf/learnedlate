---
title: "SAP BTP Side-by-Side Extension: Working Example"
...
description: "Build a SAP BTP side-by-side extension with our complete working example and code. Step-by-step guide to extend S/4HANA without modifying core."
date: "2026-03-19"
tags: ["SAP BTP", "Side-by-Side Extension", "SAP S/4HANA", "Cloud Foundry", "Clean Core"]
...
This guide walks through a complete working example: a custom sales order approval application built as a side-by-side extension. By the end, you'll have production-ready code patterns you can adapt for your own projects.
...
This approach aligns perfectly with the [Clean Core methodology](/blog/sap-clean-core/), ensuring your S/4HANA system remains stable, upgradeable, and free from custom code complications.
...
The extension only stores what S/4HANA doesn't—approval decisions and audit trails. Master data (customers, products) and transactional data (sales orders) remain in the core.

### 2. API-First Integration

All communication with S/4HANA uses public OData APIs. This ensures compatibility with future upgrades and avoids tight coupling.

### 3. Security by Default

Authentication flows through SAP BTP's XSUAA service. Users must have appropriate roles, and the destination service securely manages S/4HANA credentials.

### 4. Event-Driven Extensions

For production scenarios, consider the [SAP Event Mesh](https://help.sap.com/docs/SAP_EM) approach: S/4HANA publishes events when orders are created, and your extension consumes them asynchronously. This reduces coupling further and integrates well with [API integration services](/blog/api-integration-services-connecting-your-business-systems-seamlessly/) you may already have in place.
...
The patterns shown here apply broadly across extension types. For a deeper dive into Clean Core architecture, see our [SAP Clean Core: What It Is, Why It Matters, and How to Achieve It](/blog/sap-clean-core/) guide, and our [SAP Clean Core Assessment Checklist](/blog/sap-clean-core-assessment-checklist-a-practical-framework-for-s4hana-migration/) for evaluating your current landscape.

If you're looking to add AI capabilities to your extensions, the [SAP Joule Custom Skills Development tutorial](/blog/sap-joule-custom-skills-development-step-by-step-tutorial-for-beginners/) shows how to build custom skills that work alongside BTP extensions.
...
- [SAP Clean Core Assessment Checklist: A Practical Framework for S/4HANA Migration](/blog/sap-clean-core-assessment-checklist-a-practical-framework-for-s4hana-migration/)
...
- [API Integration Services: Connecting Your Business Systems Seamlessly](/blog/api-integration-services-connecting-your-business-systems-seamlessly/)
