---
title: "SAP BTP Side-by-Side Extension: Full Working Example"
faq:
...
description: "SAP BTP side-by-side extension guide with complete working example, source code, and step-by-step deployment. Extend S/4HANA with CAP and Node.js."
date: "2026-03-19"
...
---
SAP BTP side-by-side extension lets you build custom applications that run alongside your core S/4HANA system without modifying it. This approach uses CAP, Node.js, and React on Cloud Foundry to add new capabilities while keeping your ERP stable and upgrade-safe.
...
- **Flexibility**: Use modern languages and frameworks
- **Scalability**: Scale the extension independently from core ERP resources
- **Future-proofing**: Easier upgrades and maintenance
...
If you're looking to add AI capabilities to your extensions, the [SAP Joule Custom Skills Development tutorial](/blog/sap_joule_custom_skills_development_step_by_step_tutorial_for_beginners/) shows how to build custom skills that work alongside BTP extensions.
...
- [SAP BTP vs Traditional ABAP Development: Choosing the Right Approach](/blog/sap_btp_vs_traditional_abap_development/)
- [Understanding SAP BTP Services: A Comprehensive Overview](/blog/understanding_sap_btp_services/)
