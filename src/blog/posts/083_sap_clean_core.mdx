...
For a more detailed framework, see our [SAP Clean Core Assessment Checklist](/blog/sap-clean-core-assessment-checklist-a-practical-framework-for-s4hana-migration/).
...
For more complex requirements, the [side-by-side extension pattern](/blog/sap-btp-side-by-side-extension-complete-working-example-with-code/) moves custom logic entirely off the ERP and onto SAP BTP. The extension communicates with S/4HANA exclusively through public APIs.
