<template>
  <div class="blog-post-page">
    ...
    <article v-else-if="post" class="max-w-4xl mx-auto px-2 sm:px-4 lg:px-6 py-12 sm:py-16">
      ...
      <!-- End-of-post product CTA (AI ladder) — single primary ladder CTA -->
      <BlogPostCta />

      <!-- Author Bio (bio + one secondary link; ladder CTAs live in BlogPostCta above) -->
        ...
        <div class="flex items-start space-x-8">
          ...
          <div class="flex-1">
            ...
            <router-link
              ...
              data-track='{"event":"cta_click","cta_text":"View services","location":"blog_post_author","destination":"/services/strategy"}'
            >
              View services
            </router-link>
          </div>
