<template>
  <div class="mvp-landing">
        ...
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 text-left mt-8">
            <div class="bg-white/5 border border-white/10 rounded-xl p-4">
              <div class="text-sm text-gray-300">ExpenseSorted</div>
              <div class="text-lg font-medium">6 weeks → $8K MRR</div>
            </div>
            <div class="bg-white/5 border border-white/10 rounded-xl p-4">
              <div class="text-sm text-gray-300">TradeFlow</div>
              <div class="text-lg font-medium">8 weeks → 500 users</div>
            </div>
            <div class="bg-white/5 border border-white/10 rounded-xl p-4">
              <div class="text-sm text-gray-300">QuickBooks Add-on</div>
              <div class="text-lg font-medium">10 weeks → Acquired</div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="border border-gray-200 rounded-xl p-5">
              ...
              <ul class="text-gray-700 text-sm space-y-1 list-disc list-inside">
                ...
                <li>$100K–$500K cost</li>
                <li>50% of features never used</li>
                <li>Outdated by launch time</li>
                <li>Competitors beat you to market</li>
              </ul>
            </div>
            <div class="border border-gray-200 rounded-xl p-5">
              ...
              <ul class="text-gray-700 text-sm space-y-1 list-disc list-inside">
                ...
                <li>$15K–$50K cost</li>
                <li>Only essential features built</li>
                <li>Iterate based on real users</li>
        ...
        <div class="max-w-5xl mx-auto">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <ul class="text-gray-700 text-sm space-y-1 list-disc list-inside mt-2">
                <li>Technical feasibility analysis</li>
                <li>Interactive prototype</li>
                <li>Architecture planning</li>
                <li>Fixed-price quote</li>
              </ul>
              <p class="text-xs text-gray-500 mt-2">✓ You get: Working prototype + Go/No-go decision</p>
            </div>
            <div class="bg-white border border-gray-200 rounded-xl p-5">
              <h3 class="text-base font-medium text-gray-900">Week 3–4: Foundation</h3>
              <ul class="text-gray-700 text-sm space-y-1 list-disc list-inside mt-2">
              ...
              <p class="text-xs text-gray-500 mt-2">✓ You get: Solid technical foundation</p>
            </div>
            <div class="bg-white border border-gray-200 rounded-xl p-5">
              <h3 class="text-base font-medium text-gray-900">Week 5–6: Core Features</h3>
              <ul class="text-gray-700 text-sm space-y-1 list-disc list-inside mt-2">
                <li>Essential user flows</li>
                <li>Key feature development</li>
                <li>Mobile responsiveness</li>
                <li>Initial user testing</li>
              </ul>
              <p class="text-xs text-gray-500 mt-2">✓ You get: Working product for beta users</p>
            </div>
            <div class="bg-white border border-gray-200 rounded-xl p-5">
              <h3 class="text-base font-medium text-gray-900">Week 7–8: Launch Ready</h3>
              <ul class="text-gray-700 text-sm space-y-1 list-disc list-inside mt-2">
              ...
              <p class="text-xs text-gray-500 mt-2">✓ You get: Live product ready for customers</p>
            </div>
          </div>
    ...
    <section class="py-12 sm:py-16 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
          <h2 class="text-2xl sm:text-3xl font-light text-gray-900 mb-6">Transparent, milestone-based pricing</h2>
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="border border-gray-200 rounded-xl p-5 bg-white">
              <h3 class="font-medium text-gray-900">Feasibility Sprint</h3>
              <div class="text-2xl font-semibold text-gray-900">$5,000</div>
              <div class="text-xs text-gray-500 mb-2">100% credited to build</div>
              ...
              <a href="#sprint" class="inline-block mt-4 bg-gray-900 text-white px-5 py-2.5 rounded-md text-sm hover:bg-gray-800">Start Sprint →</a>
            </div>
            <div class="border border-gray-200 rounded-xl p-5 bg-white relative">
              <div class="absolute -top-3 right-3 text-xs bg-gray-900 text-white px-2 py-1 rounded">MOST POPULAR</div>
              <h3 class="font-medium text-gray-900">Standard MVP</h3>
              <div class="text-2xl font-semibold text-gray-900">$15,000 – $30,000</div>
              <div class="text-xs text-gray-500 mb-2">4–6 week delivery</div>
              <ul class="mt-2 text-gray-700 text-sm space-y-1 list-disc list-inside">
              ...
              <a href="mailto:hello@learnedlate.com?subject=MVP%20Development%20Inquiry" class="inline-block mt-4 bg-gray-900 text-white px-5 py-2.5 rounded-md text-sm hover:bg-gray-800">Get Started →</a>
            </div>
            <div class="border border-gray-200 rounded-xl p-5 bg-white">
              <h3 class="font-medium text-gray-900">Complex MVP</h3>
              <div class="text-2xl font-semibold text-gray-900">$30,000 – $50,000</div>
              <div class="text-xs text-gray-500 mb-2">6–8 week delivery</div>
              <ul class="mt-2 text-gray-700 text-sm space-y-1 list-disc list-inside">
                <li>Everything in Standard</li>
                <li>Advanced features (5–10)</li>
                <li>Third‑party integrations</li>
                <li>Admin dashboard</li>
                <li>Analytics setup</li>
                <li>60‑day support</li>
              </ul>
              <a href="mailto:hello@learnedlate.com?subject=Custom%20MVP%20Inquiry" class="inline-block mt-4 bg-white text-gray-900 border border-gray-300 px-5 py-2.5 rounded-md text-sm hover:bg-gray-50">Discuss Project →</a>
            </div>
          </div>
          <div class="mt-8 border border-gray-200 rounded-xl p-5 bg-white">
            <h3 class="font-medium text-gray-900 mb-1">Fair payment terms</h3>
            <p class="text-gray-700 text-sm">25% upfront • 50% at beta • 25% at launch • Money‑back if not satisfied at any milestone</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-12 sm:py-16 bg-white">
      <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
          <h2 class="text-2xl sm:text-3xl font-light text-gray-900">Your competitors are already building. Start today.</h2>
          <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 mt-6">
            <h3 class="text-lg font-medium text-gray-900">2‑Week Feasibility Sprint</h3>
            <p class="text-gray-700 mt-1">Get a working prototype and know exactly what it takes to launch</p>
            <ul class="text-gray-700 text-sm mt-3 space-y-1 list-disc list-inside">
              <li>✓ Interactive prototype in 10 days</li>
              <li>✓ Fixed‑price quote for full build</li>
              <li>✓ 100% sprint fee credited to project</li>
            </ul>
            <a href="#sprint" class="inline-block mt-4 bg-gray-900 text-white px-6 py-3 rounded-md font-medium hover:bg-gray-800">Book Your Sprint Call →</a>
            <p class="text-gray-500 text-sm mt-2">🔥 January special: Free payment processing setup ($2,000 value) with every MVP</p>
          </div>
        </div>
      </div>
    </section>
